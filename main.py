...
parser.add_argument("-s", "--speed", type=int,  help = "Port must be supplied with -p. Change the spindle speed, 3600-7200 currently")
parser.add_argument("-f", "--frequency", type=int,  help = "Port must be supplied with -p. Change the frequency, 60-120 currently")
